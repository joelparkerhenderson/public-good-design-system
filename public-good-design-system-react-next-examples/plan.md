# Public Good Design System — React Next.js Examples — Implementation Plan

## Goal

Create styled example pages demonstrating component usage with Next.js 14 + React 19 with NHS UK styling. Examples use NHS UK design system CSS for visual styling on top of headless components.

## Technology

- Framework: Next.js 14 + React 19 with NHS UK styling
