<script setup lang="ts">
    ...
    // provides formatted display content through the default slot. Commonly
    ...
    //   default slot. Formatted timer display content.
    ...
    //   - The default slot allows localized time formatting
    //
    // Claude rules:
