<script setup lang="ts">
    ...
    //   value — string, default "". Current month value in YYYY-MM format; bindable via defineModel().
    //   required — boolean, default false. Whether the input is required.
    //   disabled — boolean, default false. Whether the input is disabled.
    //   ...restProps — additional HTML attributes spread onto the <input>.
    //
    // Syntax:
    //   <MonthInput label="Start month" v-model />
    //
    // Examples:
    //   <!-- Basic month picker -->
    //   <MonthInput label="Start month" v-model />
    ...
    //   <MonthInput label="Expiration" v-model required min="2024-01" max="2030-12" />
    //
    // Keyboard:
