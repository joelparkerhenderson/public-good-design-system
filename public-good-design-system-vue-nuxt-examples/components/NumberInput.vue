<script setup lang="ts">
    ...
    //
    // Syntax:
    //   <NumberInput label="Quantity" v-model />
    //
    // Examples:
    //   <!-- Number input with constraints -->
    //   <NumberInput label="Quantity" v-model min={0} max={100} step={1} />
    //
    //   <!-- Required number input -->
    //   <NumberInput label="Age" v-model required />
    //
    // Keyboard:
    ...
    //   - Uses defineModel() for value, not defineModel()
