...
- 1342 tests across 236 test files
...
<template>
    <button class="button" :type="type" :disabled="disabled" :aria-pressed="pressed" :aria-label="label">
        <slot />
    </button>
</template>
```
