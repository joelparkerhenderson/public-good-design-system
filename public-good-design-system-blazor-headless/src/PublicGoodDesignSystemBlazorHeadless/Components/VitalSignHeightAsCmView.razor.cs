...
/// </code>
/// </example>
public partial class VitalSignHeightAsCmView : ComponentBase
{
    ...
    private string CssClasses => string.IsNullOrEmpty(CssClass) ? "vital-sign-height-as-cm-view" : $"vital-sign-height-as-cm-view {CssClass}";
}
