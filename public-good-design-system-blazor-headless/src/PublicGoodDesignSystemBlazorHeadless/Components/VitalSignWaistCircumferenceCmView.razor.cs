...
/// </code>
/// </example>
public partial class VitalSignWaistCircumferenceCmView : ComponentBase
{
    ...
    private string CssClasses => string.IsNullOrEmpty(CssClass) ? "vital-sign-waist-circumference-cm-view" : $"vital-sign-waist-circumference-cm-view {CssClass}";
}
