...
/// <summary>
/// PasswordInputOrTextInputDiv is a headless component that wraps a native `&lt;input type="password"&gt;`
...
/// </code>
/// </example>
public partial class PasswordInputOrTextInputDiv : ComponentBase
{
    ...
    private string CssClasses => string.IsNullOrEmpty(CssClass) ? "password-input-or-text-input-div" : $"password-input-or-text-input-div {CssClass}";
}
