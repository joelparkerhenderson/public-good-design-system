...
/// </code>
/// </example>
public partial class VitalSignWeightKgView : ComponentBase
{
    ...
    private string CssClasses => string.IsNullOrEmpty(CssClass) ? "vital-sign-weight-kg-view" : $"vital-sign-weight-kg-view {CssClass}";
}
