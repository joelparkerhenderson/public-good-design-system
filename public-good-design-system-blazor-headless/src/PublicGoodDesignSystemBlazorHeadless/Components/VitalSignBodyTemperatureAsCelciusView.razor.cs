...
/// </code>
/// </example>
public partial class VitalSignBodyTemperatureAsCelciusView : ComponentBase
{
    ...
    private string CssClasses => string.IsNullOrEmpty(CssClass) ? "vital-sign-body-temperature-as-celcius-view" : $"vital-sign-body-temperature-as-celcius-view {CssClass}";
}
