...
/// </code>
/// </example>
public partial class VitalSignBloodPressureDiastolicAsMmhgView : ComponentBase
{
    ...
    private string CssClasses => string.IsNullOrEmpty(CssClass) ? "vital-sign-blood-pressure-diastolic-as-mmhg-view" : $"vital-sign-blood-pressure-diastolic-as-mmhg-view {CssClass}";
}
