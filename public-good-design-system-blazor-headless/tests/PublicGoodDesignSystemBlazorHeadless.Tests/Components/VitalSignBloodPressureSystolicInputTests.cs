...
public class VitalSignBloodPressureSystolicInputTests : TestContext
{
    [Fact]
    public void RendersAsInput()
    {
        var cut = RenderComponent<VitalSignBloodPressureSystolicInput>();
    ...
    public void HasBaseClass()
    {
        var cut = RenderComponent<VitalSignBloodPressureSystolicInput>();
        var element = cut.Find("input");
        Assert.Contains("vital-sign-blood-pressure-systolic-input", element.GetAttribute("class"));
    }

    [Fact]
    public void MergesCssClass()
    {
        var cut = RenderComponent<VitalSignBloodPressureSystolicInput>(p => p
            .Add(c => c.CssClass, "custom-class"));
        var element = cut.Find("input");
        var classes = element.GetAttribute("class");
        Assert.Contains("vital-sign-blood-pressure-systolic-input", classes);
