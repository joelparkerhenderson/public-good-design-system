...
public class VitalSignHeightCmViewTests : TestContext
{
    [Fact]
    public void RendersAsSpan()
    {
        var cut = RenderComponent<VitalSignHeightCmView>();
    ...
    public void HasBaseClass()
    {
        var cut = RenderComponent<VitalSignHeightCmView>();
        var element = cut.Find("span");
        Assert.Contains("vital-sign-height-cm-view", element.GetAttribute("class"));
    }

    [Fact]
    public void MergesCssClass()
    {
        var cut = RenderComponent<VitalSignHeightCmView>(p => p
            .Add(c => c.CssClass, "custom-class"));
        var element = cut.Find("span");
        var classes = element.GetAttribute("class");
        Assert.Contains("vital-sign-height-cm-view", classes);
