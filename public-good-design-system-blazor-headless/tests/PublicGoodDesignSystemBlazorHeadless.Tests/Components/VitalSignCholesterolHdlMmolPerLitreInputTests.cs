...
public class VitalSignCholesterolHdlMmolPerLitreInputTests : TestContext
{
    [Fact]
    public void RendersAsInput()
    {
        var cut = RenderComponent<VitalSignCholesterolHdlMmolPerLitreInput>();
    ...
    public void HasBaseClass()
    {
        var cut = RenderComponent<VitalSignCholesterolHdlMmolPerLitreInput>();
        var element = cut.Find("input");
        Assert.Contains("vital-sign-cholesterol-hdl-mmol-per-litre-input", element.GetAttribute("class"));
    }

    [Fact]
    public void MergesCssClass()
    {
        var cut = RenderComponent<VitalSignCholesterolHdlMmolPerLitreInput>(p => p
            .Add(c => c.CssClass, "custom-class"));
        var element = cut.Find("input");
        var classes = element.GetAttribute("class");
        Assert.Contains("vital-sign-cholesterol-hdl-mmol-per-litre-input", classes);
