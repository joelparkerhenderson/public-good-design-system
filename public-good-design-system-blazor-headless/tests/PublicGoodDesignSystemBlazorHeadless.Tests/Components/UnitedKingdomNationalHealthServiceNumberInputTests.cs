...
public class UnitedKingdomNationalHealthServiceNumberInputTests : TestContext
{
    ...
    {
        var cut = RenderComponent<UnitedKingdomNationalHealthServiceNumberInput>();
    ...
    public void HasBaseClass()
    {
        var cut = RenderComponent<UnitedKingdomNationalHealthServiceNumberInput>();
        var element = cut.Find("input");
        Assert.Contains("united-kingdom-national-health-service-number-input", element.GetAttribute("class"));
    }
    ...
    public void MergesCssClass()
    {
        ...
        Assert.Contains("united-kingdom-national-health-service-number-input", classes);
