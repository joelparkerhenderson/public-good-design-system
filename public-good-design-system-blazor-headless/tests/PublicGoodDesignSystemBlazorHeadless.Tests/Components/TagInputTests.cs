...
public class TagInputTests : TestContext
{
    ...
    public void HasBaseClass()
    {
        var cut = RenderComponent<TagInput>();
        var element = cut.Find("input");
        Assert.Contains("tag-input", element.GetAttribute("class"));
    }
    ...
    public void MergesCssClass()
    {
        ...
        Assert.Contains("tag-input", classes);
    ...
    [Fact]
    public void OnaddDefaultIsEmptyString()
    {
        var cut = RenderComponent<TagInput>();
        // Default value for Onadd should be ""
        Assert.NotNull(cut.Instance);
    }
