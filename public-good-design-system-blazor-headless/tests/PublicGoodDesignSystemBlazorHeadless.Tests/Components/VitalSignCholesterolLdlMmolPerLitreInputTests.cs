...
public class VitalSignCholesterolLdlMmolPerLitreInputTests : TestContext
{
    [Fact]
    public void RendersAsInput()
    {
        var cut = RenderComponent<VitalSignCholesterolLdlMmolPerLitreInput>();
    ...
    public void HasBaseClass()
    {
        var cut = RenderComponent<VitalSignCholesterolLdlMmolPerLitreInput>();
        var element = cut.Find("input");
        Assert.Contains("vital-sign-cholesterol-ldl-mmol-per-litre-input", element.GetAttribute("class"));
    }

    [Fact]
    public void MergesCssClass()
    {
        var cut = RenderComponent<VitalSignCholesterolLdlMmolPerLitreInput>(p => p
            .Add(c => c.CssClass, "custom-class"));
        var element = cut.Find("input");
        var classes = element.GetAttribute("class");
        Assert.Contains("vital-sign-cholesterol-ldl-mmol-per-litre-input", classes);
