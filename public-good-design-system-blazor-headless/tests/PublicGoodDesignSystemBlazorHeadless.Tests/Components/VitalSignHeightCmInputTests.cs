...
public class VitalSignHeightCmInputTests : TestContext
{
    [Fact]
    public void RendersAsInput()
    {
        var cut = RenderComponent<VitalSignHeightCmInput>();
    ...
    public void HasBaseClass()
    {
        var cut = RenderComponent<VitalSignHeightCmInput>();
        var element = cut.Find("input");
        Assert.Contains("vital-sign-height-cm-input", element.GetAttribute("class"));
    }

    [Fact]
    public void MergesCssClass()
    {
        var cut = RenderComponent<VitalSignHeightCmInput>(p => p
            .Add(c => c.CssClass, "custom-class"));
        var element = cut.Find("input");
        var classes = element.GetAttribute("class");
        Assert.Contains("vital-sign-height-cm-input", classes);
