...
public class RedAmberGreenPickerTests : TestContext
{
    ...
    {
        var cut = RenderComponent<RedAmberGreenPicker>();
    ...
    public void HasBaseClass()
    {
        var cut = RenderComponent<RedAmberGreenPicker>();
        var element = cut.Find("select");
        Assert.Contains("red-amber-green-picker", element.GetAttribute("class"));
    }
    ...
    public void MergesCssClass()
    {
        ...
        Assert.Contains("red-amber-green-picker", classes);
