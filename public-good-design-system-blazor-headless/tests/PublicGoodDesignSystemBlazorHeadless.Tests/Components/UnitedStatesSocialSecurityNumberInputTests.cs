...
public class UnitedStatesSocialSecurityNumberInputTests : TestContext
{
    ...
    {
        var cut = RenderComponent<UnitedStatesSocialSecurityNumberInput>();
    ...
    public void HasBaseClass()
    {
        var cut = RenderComponent<UnitedStatesSocialSecurityNumberInput>();
        var element = cut.Find("input");
        Assert.Contains("united-states-social-security-number-input", element.GetAttribute("class"));
    }
    ...
    public void MergesCssClass()
    {
        ...
        Assert.Contains("united-states-social-security-number-input", classes);
