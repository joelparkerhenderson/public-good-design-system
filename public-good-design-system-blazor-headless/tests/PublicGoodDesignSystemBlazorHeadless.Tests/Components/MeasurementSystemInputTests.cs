...
public class MeasurementSystemInputTests : TestContext
{
    ...
    {
        var cut = RenderComponent<MeasurementSystemInput>();
    ...
    public void HasBaseClass()
    {
        var cut = RenderComponent<MeasurementSystemInput>();
        var element = cut.Find("input");
        Assert.Contains("measurement-system-input", element.GetAttribute("class"));
    }
    ...
    public void MergesCssClass()
    {
        ...
        Assert.Contains("measurement-system-input", classes);
