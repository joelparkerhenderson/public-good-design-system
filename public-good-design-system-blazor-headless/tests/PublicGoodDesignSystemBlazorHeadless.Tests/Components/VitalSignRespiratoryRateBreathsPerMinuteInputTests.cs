...
public class VitalSignRespiratoryRateBreathsPerMinuteInputTests : TestContext
{
    [Fact]
    public void RendersAsInput()
    {
        var cut = RenderComponent<VitalSignRespiratoryRateBreathsPerMinuteInput>();
    ...
    public void HasBaseClass()
    {
        var cut = RenderComponent<VitalSignRespiratoryRateBreathsPerMinuteInput>();
        var element = cut.Find("input");
        Assert.Contains("vital-sign-respiratory-rate-breaths-per-minute-input", element.GetAttribute("class"));
    }

    [Fact]
    public void MergesCssClass()
    {
        var cut = RenderComponent<VitalSignRespiratoryRateBreathsPerMinuteInput>(p => p
            .Add(c => c.CssClass, "custom-class"));
        var element = cut.Find("input");
        var classes = element.GetAttribute("class");
        Assert.Contains("vital-sign-respiratory-rate-breaths-per-minute-input", classes);
