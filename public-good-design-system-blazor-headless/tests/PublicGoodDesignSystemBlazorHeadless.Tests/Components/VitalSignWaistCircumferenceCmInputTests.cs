...
public class VitalSignWaistCircumferenceCmInputTests : TestContext
{
    [Fact]
    public void RendersAsInput()
    {
        var cut = RenderComponent<VitalSignWaistCircumferenceCmInput>();
    ...
    public void HasBaseClass()
    {
        var cut = RenderComponent<VitalSignWaistCircumferenceCmInput>();
        var element = cut.Find("input");
        Assert.Contains("vital-sign-waist-circumference-cm-input", element.GetAttribute("class"));
    }

    [Fact]
    public void MergesCssClass()
    {
        var cut = RenderComponent<VitalSignWaistCircumferenceCmInput>(p => p
            .Add(c => c.CssClass, "custom-class"));
        var element = cut.Find("input");
        var classes = element.GetAttribute("class");
        Assert.Contains("vital-sign-waist-circumference-cm-input", classes);
