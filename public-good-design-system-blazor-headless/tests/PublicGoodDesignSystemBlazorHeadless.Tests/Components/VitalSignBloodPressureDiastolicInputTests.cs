...
public class VitalSignBloodPressureDiastolicInputTests : TestContext
{
    [Fact]
    public void RendersAsInput()
    {
        var cut = RenderComponent<VitalSignBloodPressureDiastolicInput>();
    ...
    public void HasBaseClass()
    {
        var cut = RenderComponent<VitalSignBloodPressureDiastolicInput>();
        var element = cut.Find("input");
        Assert.Contains("vital-sign-blood-pressure-diastolic-input", element.GetAttribute("class"));
    }

    [Fact]
    public void MergesCssClass()
    {
        var cut = RenderComponent<VitalSignBloodPressureDiastolicInput>(p => p
            .Add(c => c.CssClass, "custom-class"));
        var element = cut.Find("input");
        var classes = element.GetAttribute("class");
        Assert.Contains("vital-sign-blood-pressure-diastolic-input", classes);
