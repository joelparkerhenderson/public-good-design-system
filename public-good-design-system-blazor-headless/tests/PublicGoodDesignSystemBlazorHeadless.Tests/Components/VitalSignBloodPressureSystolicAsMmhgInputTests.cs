...
public class VitalSignBloodPressureSystolicAsMmhgInputTests : TestContext
{
    [Fact]
    public void RendersAsInput()
    {
        var cut = RenderComponent<VitalSignBloodPressureSystolicAsMmhgInput>();
    ...
    public void HasBaseClass()
    {
        var cut = RenderComponent<VitalSignBloodPressureSystolicAsMmhgInput>();
        var element = cut.Find("input");
        Assert.Contains("vital-sign-blood-pressure-systolic-as-mmhg-input", element.GetAttribute("class"));
    }

    [Fact]
    public void MergesCssClass()
    {
        var cut = RenderComponent<VitalSignBloodPressureSystolicAsMmhgInput>(p => p
            .Add(c => c.CssClass, "custom-class"));
        var element = cut.Find("input");
        var classes = element.GetAttribute("class");
        Assert.Contains("vital-sign-blood-pressure-systolic-as-mmhg-input", classes);
    ...
    {
        var cut = RenderComponent<VitalSignBloodPressureSystolicAsMmhgInput>(p => p
            .Add(c => c.Label, "Systolic blood pressure (mmHg)"));
        var element = cut.Find("input");
        Assert.Equal("Systolic blood pressure (mmHg)", element.GetAttribute("aria-label"));
    }
