...
public class MeasurementUnitInputTests : TestContext
{
    ...
    {
        var cut = RenderComponent<MeasurementUnitInput>();
    ...
    public void HasBaseClass()
    {
        var cut = RenderComponent<MeasurementUnitInput>();
        var element = cut.Find("input");
        Assert.Contains("measurement-unit-input", element.GetAttribute("class"));
    }
    ...
    public void MergesCssClass()
    {
        ...
        Assert.Contains("measurement-unit-input", classes);
