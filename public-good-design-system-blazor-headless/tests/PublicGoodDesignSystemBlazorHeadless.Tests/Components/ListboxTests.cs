...
public class ListboxTests : TestContext
{
    ...
    public void HasBaseClass()
    {
        var cut = RenderComponent<Listbox>(p => p
            .AddChildContent("Test content"));
        var element = cut.Find("div");
        Assert.Contains("listbox", element.GetAttribute("class"));
    }
    ...
    public void MergesCssClass()
    {
        ...
        Assert.Contains("listbox", classes);
    ...
    [Fact]
    public void HasRoleListbox()
    {
        var cut = RenderComponent<Listbox>(p => p
            .AddChildContent("Test content"));
        var element = cut.Find("div");
        Assert.Equal("listbox", element.GetAttribute("role"));
    }
