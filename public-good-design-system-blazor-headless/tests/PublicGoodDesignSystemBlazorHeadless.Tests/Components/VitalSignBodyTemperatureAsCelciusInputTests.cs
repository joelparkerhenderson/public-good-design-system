...
public class VitalSignBodyTemperatureAsCelciusInputTests : TestContext
{
    [Fact]
    public void RendersAsInput()
    {
        var cut = RenderComponent<VitalSignBodyTemperatureAsCelciusInput>();
    ...
    public void HasBaseClass()
    {
        var cut = RenderComponent<VitalSignBodyTemperatureAsCelciusInput>();
        var element = cut.Find("input");
        Assert.Contains("vital-sign-body-temperature-as-celcius-input", element.GetAttribute("class"));
    }

    [Fact]
    public void MergesCssClass()
    {
        var cut = RenderComponent<VitalSignBodyTemperatureAsCelciusInput>(p => p
            .Add(c => c.CssClass, "custom-class"));
        var element = cut.Find("input");
        var classes = element.GetAttribute("class");
        Assert.Contains("vital-sign-body-temperature-as-celcius-input", classes);
