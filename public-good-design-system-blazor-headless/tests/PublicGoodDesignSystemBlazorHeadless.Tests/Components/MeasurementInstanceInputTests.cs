...
public class MeasurementInstanceInputTests : TestContext
{
    ...
    {
        var cut = RenderComponent<MeasurementInstanceInput>();
    ...
    public void HasBaseClass()
    {
        var cut = RenderComponent<MeasurementInstanceInput>();
        var element = cut.Find("input");
        Assert.Contains("measurement-instance-input", element.GetAttribute("class"));
    }
    ...
    public void MergesCssClass()
    {
        ...
        Assert.Contains("measurement-instance-input", classes);
