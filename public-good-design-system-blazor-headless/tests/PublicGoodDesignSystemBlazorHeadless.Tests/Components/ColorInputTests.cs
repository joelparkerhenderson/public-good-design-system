...
public class ColorInputTests : TestContext
{
    ...
    {
        var cut = RenderComponent<ColorInput>();
    ...
    public void HasBaseClass()
    {
        var cut = RenderComponent<ColorInput>();
        var element = cut.Find("input");
        Assert.Contains("color-input", element.GetAttribute("class"));
    }
    ...
    public void MergesCssClass()
    {
        ...
        Assert.Contains("color-input", classes);
    ...
    [Fact]
    public void ValueDefaultIs000000()
    {
        var cut = RenderComponent<ColorInput>();
        // Default value for Value should be "#000000"
