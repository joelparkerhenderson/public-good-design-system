...
public class VitalSignBodyTemperatureAsCelciusViewTests : TestContext
{
    [Fact]
    public void RendersAsSpan()
    {
        var cut = RenderComponent<VitalSignBodyTemperatureAsCelciusView>();
    ...
    public void HasBaseClass()
    {
        var cut = RenderComponent<VitalSignBodyTemperatureAsCelciusView>();
        var element = cut.Find("span");
        Assert.Contains("vital-sign-body-temperature-as-celcius-view", element.GetAttribute("class"));
    }

    [Fact]
    public void MergesCssClass()
    {
        var cut = RenderComponent<VitalSignBodyTemperatureAsCelciusView>(p => p
            .Add(c => c.CssClass, "custom-class"));
        var element = cut.Find("span");
        var classes = element.GetAttribute("class");
        Assert.Contains("vital-sign-body-temperature-as-celcius-view", classes);
