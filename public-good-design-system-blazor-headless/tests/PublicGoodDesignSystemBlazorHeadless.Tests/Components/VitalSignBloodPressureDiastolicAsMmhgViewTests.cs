...
public class VitalSignBloodPressureDiastolicAsMmhgViewTests : TestContext
{
    [Fact]
    public void RendersAsSpan()
    {
        var cut = RenderComponent<VitalSignBloodPressureDiastolicAsMmhgView>();
    ...
    public void HasBaseClass()
    {
        var cut = RenderComponent<VitalSignBloodPressureDiastolicAsMmhgView>();
        var element = cut.Find("span");
        Assert.Contains("vital-sign-blood-pressure-diastolic-as-mmhg-view", element.GetAttribute("class"));
    }

    [Fact]
    public void MergesCssClass()
    {
        var cut = RenderComponent<VitalSignBloodPressureDiastolicAsMmhgView>(p => p
            .Add(c => c.CssClass, "custom-class"));
        var element = cut.Find("span");
        var classes = element.GetAttribute("class");
        Assert.Contains("vital-sign-blood-pressure-diastolic-as-mmhg-view", classes);
