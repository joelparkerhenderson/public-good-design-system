...
public class VitalSignWeightKgInputTests : TestContext
{
    [Fact]
    public void RendersAsInput()
    {
        var cut = RenderComponent<VitalSignWeightKgInput>();
    ...
    public void HasBaseClass()
    {
        var cut = RenderComponent<VitalSignWeightKgInput>();
        var element = cut.Find("input");
        Assert.Contains("vital-sign-weight-kg-input", element.GetAttribute("class"));
    }

    [Fact]
    public void MergesCssClass()
    {
        var cut = RenderComponent<VitalSignWeightKgInput>(p => p
            .Add(c => c.CssClass, "custom-class"));
        var element = cut.Find("input");
        var classes = element.GetAttribute("class");
        Assert.Contains("vital-sign-weight-kg-input", classes);
