...
- Accepts an optional `ChildContent` RenderFragment for placeholder shapes (e.g., lines, circles, rectangles)
- Spreads `AdditionalAttributes` for consumer customization (e.g., sizing, data attributes)
