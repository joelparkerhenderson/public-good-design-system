...
- Accepts a `ChildContent` RenderFragment for dialog content including buttons, forms, or text
- Spreads `AdditionalAttributes` onto the `<dialog>` element for consumer customization
...
| `Modal` | `bool` | `true` | The modal value |
