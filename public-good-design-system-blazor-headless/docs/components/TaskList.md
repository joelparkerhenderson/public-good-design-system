...
task items as `<li>` children through the ChildContent render fragment.
...
- All task content provided through ChildContent render fragment (should be `<li>` elements)
