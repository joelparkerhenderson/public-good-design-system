...
- Accepts a `ChildContent` RenderFragment for flexible footnote content (text, links, citations)
- Spreads `AdditionalAttributes` onto the `<aside>` element for consumer customization
