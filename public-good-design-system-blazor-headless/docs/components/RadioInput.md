...
- Does not use `@bind-` for checked state; consumers can use event handlers or bind directly
- Spreads `AdditionalAttributes` for consumer customization (e.g., `onchange`, `id`)
