...
- Uses `private field` to track the tree element reference for keyboard navigation
...
- Accepts `AdditionalAttributes` for forwarding additional attributes to the list element
