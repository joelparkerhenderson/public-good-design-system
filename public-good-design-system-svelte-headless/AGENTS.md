...
- image-input = ImageInput = a graphical submit button that displays an image
...
- password-input = PasswordInput = an input for entering a password with obscured text
- password-input-or-text-input-div = PasswordInputOrTextInputDiv = an input for entering a password or text with show/hide toggle
...
- table:
  ...
  - table-head = TableHead = a table header section
  - table-body = TableBody = a table body section
  - table-foot = TableFoot = a table footer section
  - table-col = TableCol = a table column
  - table-row = TableRow = a table row
  - table-data = TableData = a table data cell
...
- vital-sign:
  ...
  - vital-sign-sleep-score-as-0-to-100-view = VitalSignSleepScoreAs0To100View = number display of one vital sign sleep score from 0 to 100 with integers
  - vital-sign-sleep-score-as-0-to-100-input = VitalSignSleepScoreAs0To100Input = number input of one vital sign sleep score from 0 to 100 with integers
  - vital-sign-total-sleep-time-as-min-per-day-view = VitalSignTotalSleepTimeAsMinPerDayView = number display of one vital sign total sleep time in minutes per day with integers
  - vital-sign-total-sleep-time-as-min-per-day-input = VitalSignTotalSleepTimeAsMinPerDayInput = number input of one vital sign total sleep time in minutes per day with integers
...
- Svetle HTML first tag attribute sets the class using format: `class={`component-kebab-title ${className}`}`
