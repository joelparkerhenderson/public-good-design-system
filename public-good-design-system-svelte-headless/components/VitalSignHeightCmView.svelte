<script lang="ts">
    // VitalSignHeightCmView component
    //
    // A read-only display of a height value in centimeters. This is a
    ...
    //   value — number, required. Height value in centimeters to display.
    ...
    //
    // Examples:
    //   <!-- Display a normal height -->
    //   <VitalSignHeightCmView value={170} label="170 cm height" />
    //
    //   <!-- Display a tall height -->
    //   <VitalSignHeightCmView value={195} label="195 cm height" />
    //
    // Keyboard:
...
<!-- VitalSignHeightCmView.svelte -->
<span
    class={`vital-sign-height-cm-view ${className}`}
    role="img"
    aria-label={label}
    data-value={value}
    {...restProps}
