<script lang="ts">
    // VitalSignWeightKgView component
    //
    // A read-only display of a weight value in kilograms. This is a
    ...
    //   value — number, required. Weight value in kilograms to display.
    ...
    //
    // Examples:
    //   <!-- Display a normal weight -->
    //   <VitalSignWeightKgView value={70} label="70 kg weight" />
    //
    //   <!-- Display a heavy weight -->
    //   <VitalSignWeightKgView value={120} label="120 kg weight" />
    //
    // Keyboard:
...
<!-- VitalSignWeightKgView.svelte -->
<span
    class={`vital-sign-weight-kg-view ${className}`}
    role="img"
    aria-label={label}
    data-value={value}
    {...restProps}
