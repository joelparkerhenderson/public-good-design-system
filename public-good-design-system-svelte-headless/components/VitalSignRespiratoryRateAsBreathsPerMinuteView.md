...
This component is useful for patient monitors, health dashboards, medical records, fitness applications, or any context that displays a respiratory rate reading. It is the display-only companion to VitalSignRespiratoryRateAsBreathsPerMinuteInput.
