<script lang="ts">
    ...
    //
    // A read-only display of a waist circumference value in centimeters. This is a
    ...
    //   value — number, required. Waist circumference value in centimeters to display.
    ...
    //   <VitalSignWaistCircumferenceCmView value={110} label="110 cm waist circumference" />
    //
    // Keyboard:
...
<!-- VitalSignWaistCircumferenceCmView.svelte -->
<span
    class={`vital-sign-waist-circumference-cm-view ${className}`}
    role="img"
    aria-label={label}
    data-value={value}
    {...restProps}
