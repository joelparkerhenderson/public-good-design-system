...
This component is useful for patient intake forms, health assessments, clinical applications, medical records, or any form field that accepts a systolic blood pressure in mmHg. It is the input companion to VitalSignBloodPressureSystolicAsMmhgView.
...
```svelte
<VitalSignBloodPressureSystolicAsMmhgInput label="Systolic blood pressure (mmHg)" bind:value />
```
