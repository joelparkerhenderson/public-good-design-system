<script lang="ts">
    ...
    //   value — number, required. Systolic blood pressure value in mmHg to display.
    ...
    //
    // Examples:
    //   <!-- Display a normal systolic blood pressure -->
    //   <VitalSignBloodPressureSystolicView value={120} label="120 mmHg systolic" />
    //
    //   <!-- Display an elevated systolic blood pressure -->
...
<!-- VitalSignBloodPressureSystolicView.svelte -->
<span
    class={`vital-sign-blood-pressure-systolic-view ${className}`}
    role="img"
    aria-label={label}
    data-value={value}
    {...restProps}
