// Example: Project history timeline with cards, badges, and metadata
//
// Demonstrates: TimelineList, TimelineListItem, Card, Badge, DateRange,
// ReviewDate, SummaryList, SummaryListItem
