// Example: Task management interface with adding, completing, filtering, and progress
//
// Demonstrates: TaskList, TaskListItem, CheckboxInput, TextInput, Button, Badge, Progress
