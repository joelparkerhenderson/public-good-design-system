...
//
//
//   <VitalSignCholesterolHdlMmolPerLitreInput label="HDL cholesterol" value={value} onChange={setValue} required />
//
// Keyboard:
...
export interface VitalSignCholesterolHdlMmolPerLitreInputProps {
    className?: string;
    label: string;
...
export default function VitalSignCholesterolHdlMmolPerLitreInput({
    className = "",
    label,
    value = undefined,
    min = 0,
    ...
    onChange,
    ...restProps
}: VitalSignCholesterolHdlMmolPerLitreInputProps) {
    return (
        <input
            className={`vital-sign-cholesterol-hdl-mmol-per-litre-input ${className}`}
            type="number"
            aria-label={label}
            value={value}
