...
VitalSignCholesterolAsHdlMmolPerLitreInput is a headless component that wraps a native `<input type="number">` element for entering an HDL cholesterol value in millimoles per litre. It provides accessible labelling and clinically appropriate default constraints (0-10 mmol/L).
