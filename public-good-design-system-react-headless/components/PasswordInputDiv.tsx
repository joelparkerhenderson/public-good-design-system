...
//
// Syntax:
//   <PasswordInputDiv label="Password" value={value} onChange={setValue} />
//
// Examples:
//
//   <PasswordInputDiv label="Password" value={value} onChange={setValue} />
//
//
//   <PasswordInputDiv label="Password" value={value} onChange={setValue} showToggle={false} />
//
//
//   <PasswordInputDiv label="Mot de passe" value={value} onChange={setValue} toggleLabel="Afficher le mot de passe" />
//
// Keyboard:
...
export interface PasswordInputDivProps {
    className?: string;
    label: string;
    value?: string;
    showToggle?: boolean;
...
export default function PasswordInputDiv({
    className = "",
    label,
    value = "",
    showToggle = true,
    ...
    onChange,
    ...restProps
}: PasswordInputDivProps) {
    const [visible, setVisible] = useState(false);

    return (
        <div
        className={`password-input-div ${className}`}
        {...restProps}
        >
        <input
