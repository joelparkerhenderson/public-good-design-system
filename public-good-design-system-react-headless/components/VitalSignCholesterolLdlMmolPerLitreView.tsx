// VitalSignCholesterolLdlMmolPerLitreView component
//
...
// to VitalSignCholesterolLdlMmolPerLitreInput, used for showing LDL cholesterol
...
//
//
//   <VitalSignCholesterolLdlMmolPerLitreView value={3.0} label="3.0 mmol/L LDL cholesterol" />
//
// Keyboard:
...
export interface VitalSignCholesterolLdlMmolPerLitreViewProps {
    className?: string;
...
export default function VitalSignCholesterolLdlMmolPerLitreView({
    className = "",
    value,
    label,
    ...restProps
}: VitalSignCholesterolLdlMmolPerLitreViewProps) {
    return (
        <span
            className={`vital-sign-cholesterol-ldl-mmol-per-litre-view ${className}`}
            role="img"
            aria-label={label}
            data-value={value}
            {...restProps}
