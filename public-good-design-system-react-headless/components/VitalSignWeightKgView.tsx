...
// to VitalSignWeightKgInput, used for showing weight
...
//
//
//   <VitalSignWeightKgView value={60} label="60 kg weight" />
//
// Keyboard:
...
export interface VitalSignWeightKgViewProps {
    className?: string;
...
export default function VitalSignWeightKgView({
    className = "",
    value,
    label,
    ...restProps
}: VitalSignWeightKgViewProps) {
    return (
        <span
            className={`vital-sign-weight-kg-view ${className}`}
            role="img"
            aria-label={label}
            data-value={value}
            {...restProps}
