...
export interface UnitedKingdomNationalHealthServiceNumberViewProps {
    className?: string;
...
export default function UnitedKingdomNationalHealthServiceNumberView({
    className = "",
    label,
    value = "",
    ...restProps
}: UnitedKingdomNationalHealthServiceNumberViewProps) {
    return (
        <span
        className={`united-kingdom-national-health-service-number-view ${className}`}
        aria-label={label}
