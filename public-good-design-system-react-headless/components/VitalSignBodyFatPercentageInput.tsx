...
//
//
//   <VitalSignBodyFatPercentageInput label="Body fat percentage" value={value} onChange={setValue} required />
//
// Keyboard:
...
export interface VitalSignBodyFatPercentageInputProps {
    className?: string;
    label: string;
...
export default function VitalSignBodyFatPercentageInput({
    className = "",
    label,
    value = undefined,
    min = 0,
    ...
    onChange,
    ...restProps
}: VitalSignBodyFatPercentageInputProps) {
    return (
        <input
            className={`vital-sign-body-fat-percentage-input ${className}`}
            type="number"
            aria-label={label}
            value={value}
