...
// to VitalSignHeightCmInput, used for showing height
...
//
//
//   <VitalSignHeightCmView value={160} label="160 cm height" />
//
// Keyboard:
...
export interface VitalSignHeightCmViewProps {
    className?: string;
...
export default function VitalSignHeightCmView({
    className = "",
    value,
    label,
    ...restProps
}: VitalSignHeightCmViewProps) {
    return (
        <span
            className={`vital-sign-height-cm-view ${className}`}
            role="img"
            aria-label={label}
            data-value={value}
            {...restProps}
