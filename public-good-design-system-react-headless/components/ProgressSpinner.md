...
- Accepts an optional `children` ReactNode for content inside (e.g., loading text)
...
- `children`: ReactNode (default: `undefined`) -- optional content rendered inside (e.g., "Loading...")
