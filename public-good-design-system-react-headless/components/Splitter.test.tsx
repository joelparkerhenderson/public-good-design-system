...
import Subject from "./Splitter";

describe("Splitter", () => {
    test("renders a separator", () => {
        render(<Subject label="Resize" />);
        expect(screen.getByRole("separator")).toBeTruthy();
    });

    test("has aria-label", () => {
        render(<Subject label="Resize panels" />);
    ...
    test("supports horizontal orientation", () => {
        render(<Subject label="Resize" orientation="horizontal" />);
    ...
    test("passes through attributes", () => {
        render(<Subject label="R" data-testid="sp" />);
