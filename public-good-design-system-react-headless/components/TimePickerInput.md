...
- `value`: string (default: "") -- current time value in HH:MM format; controlled
...
```tsx
<TimePickerInput label="Appointment time" value + onChange />
```

```tsx
<TimePickerInput label="Departure time" value + onChange required />
```
