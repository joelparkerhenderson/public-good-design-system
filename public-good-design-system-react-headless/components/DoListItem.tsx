...
//   children — ReactNode, required. The recommendation content.
...
//   - Consumer can target [data-recommendation="do"] for visual styling
//
// References:
...
export default function DoListItem({
    ...
    return (
        <li
        className={`do-list-item ${className}`}
