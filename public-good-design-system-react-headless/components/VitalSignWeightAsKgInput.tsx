// VitalSignWeightAsKgInput component
//
// A headless numeric input for entering a weight value in
// kilograms (kg). Wraps a native <input type="number"> element with accessible
...
//   value — number | undefined, default undefined. Current weight value; controlled.
...
//
// Syntax:
//   <VitalSignWeightAsKgInput label="Weight (kg)" value={value} onChange={setValue} />
//
// Examples:
//
//   <VitalSignWeightAsKgInput label="Weight (kg)" value={value} onChange={setValue} />
//
//
//   <VitalSignWeightAsKgInput label="Weight (kg)" value={value} onChange={setValue} required />
//
// Keyboard:
...
export interface VitalSignWeightAsKgInputProps {
    className?: string;
    label: string;
...
export default function VitalSignWeightAsKgInput({
    className = "",
    label,
    value = undefined,
    min = 0,
    ...
    onChange,
    ...restProps
}: VitalSignWeightAsKgInputProps) {
    return (
        <input
            className={`vital-sign-weight-as-kg-input ${className}`}
            type="number"
            aria-label={label}
            value={value}
