...
//   value — number | undefined, default undefined. Current height value; controlled.
...
//
// Syntax:
//   <VitalSignHeightAsCmInput label="Height (cm)" value={value} onChange={setValue} />
//
// Examples:
//
//   <VitalSignHeightAsCmInput label="Height (cm)" value={value} onChange={setValue} />
//
//
//   <VitalSignHeightAsCmInput label="Height (cm)" value={value} onChange={setValue} required />
//
// Keyboard:
...
export interface VitalSignHeightAsCmInputProps {
    className?: string;
    label: string;
...
export default function VitalSignHeightAsCmInput({
    className = "",
    label,
    value = undefined,
    min = 0,
    ...
    onChange,
    ...restProps
}: VitalSignHeightAsCmInputProps) {
    return (
        <input
            className={`vital-sign-height-as-cm-input ${className}`}
            type="number"
            aria-label={label}
            value={value}
