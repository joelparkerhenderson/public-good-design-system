...
//
// Syntax:
//   <VitalSignCholesterolLdlMmolPerLitreInput label="LDL cholesterol" value={value} onChange={setValue} />
//
// Examples:
//
//   <VitalSignCholesterolLdlMmolPerLitreInput label="LDL cholesterol" value={value} onChange={setValue} />
//
//
//   <VitalSignCholesterolLdlMmolPerLitreInput label="LDL cholesterol" value={value} onChange={setValue} required />
//
// Keyboard:
...
export interface VitalSignCholesterolLdlMmolPerLitreInputProps {
    className?: string;
    label: string;
...
export default function VitalSignCholesterolLdlMmolPerLitreInput({
    className = "",
    label,
    value = undefined,
    min = 0,
    ...
    onChange,
    ...restProps
}: VitalSignCholesterolLdlMmolPerLitreInputProps) {
    return (
        <input
            className={`vital-sign-cholesterol-ldl-mmol-per-litre-input ${className}`}
            type="number"
            aria-label={label}
            value={value}
