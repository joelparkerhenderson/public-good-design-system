...
- Accepts an optional `children` ReactNode for placeholder shapes (e.g., lines, circles, rectangles)
- Spreads `restProps` for consumer customization (e.g., sizing, data attributes)

## Props

- `children`: ReactNode (default: `undefined`) -- optional placeholder content (e.g., skeleton line shapes)
