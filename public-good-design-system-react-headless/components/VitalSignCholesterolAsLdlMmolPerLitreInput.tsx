...
//   value — number | undefined, default undefined. Current LDL cholesterol value; controlled.
...
//
// Syntax:
//   <VitalSignCholesterolAsLdlMmolPerLitreInput label="LDL cholesterol" value={value} onChange={setValue} />
//
// Examples:
//
//   <VitalSignCholesterolAsLdlMmolPerLitreInput label="LDL cholesterol" value={value} onChange={setValue} />
//
//
//   <VitalSignCholesterolAsLdlMmolPerLitreInput label="LDL cholesterol" value={value} onChange={setValue} required />
//
// Keyboard:
...
export interface VitalSignCholesterolAsLdlMmolPerLitreInputProps {
    className?: string;
    label: string;
...
export default function VitalSignCholesterolAsLdlMmolPerLitreInput({
    className = "",
    label,
    value = undefined,
    min = 0,
    ...
    onChange,
    ...restProps
}: VitalSignCholesterolAsLdlMmolPerLitreInputProps) {
    return (
        <input
            className={`vital-sign-cholesterol-as-ldl-mmol-per-litre-input ${className}`}
            type="number"
            aria-label={label}
            value={value}
