...
// to VitalSignBodyTemperatureCelciusInput, used for showing body temperature
...
//
//
//   <VitalSignBodyTemperatureCelciusView value={38.5} label="38.5 degrees Celsius" />
//
// Keyboard:
...
export interface VitalSignBodyTemperatureCelciusViewProps {
    className?: string;
...
export default function VitalSignBodyTemperatureCelciusView({
    className = "",
    value,
    label,
    ...restProps
}: VitalSignBodyTemperatureCelciusViewProps) {
    return (
        <span
            className={`vital-sign-body-temperature-celcius-view ${className}`}
            role="img"
            aria-label={label}
            data-value={value}
            {...restProps}
