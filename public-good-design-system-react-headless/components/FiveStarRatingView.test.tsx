...
describe("FiveStarRatingView", () => {
    ...
    test("passes through attributes", () => {
        render(<Subject value={1} label="R" data-testid="rv" />);
