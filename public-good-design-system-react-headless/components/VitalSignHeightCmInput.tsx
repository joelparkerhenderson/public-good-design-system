...
//
//
//   <VitalSignHeightCmInput label="Height (cm)" value={value} onChange={setValue} required />
//
// Keyboard:
...
export interface VitalSignHeightCmInputProps {
    className?: string;
    label: string;
...
export default function VitalSignHeightCmInput({
    className = "",
    label,
    value = undefined,
    min = 0,
    ...
    onChange,
    ...restProps
}: VitalSignHeightCmInputProps) {
    return (
        <input
            className={`vital-sign-height-cm-input ${className}`}
            type="number"
            aria-label={label}
            value={value}
