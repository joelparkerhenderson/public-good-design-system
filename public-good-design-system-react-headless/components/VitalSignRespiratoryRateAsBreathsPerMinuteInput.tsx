// VitalSignRespiratoryRateAsBreathsPerMinuteInput component
//
...
//
//
//   <VitalSignRespiratoryRateAsBreathsPerMinuteInput label="Respiratory rate" value={value} onChange={setValue} required />
//
// Keyboard:
...
export interface VitalSignRespiratoryRateAsBreathsPerMinuteInputProps {
    className?: string;
    label: string;
...
export default function VitalSignRespiratoryRateAsBreathsPerMinuteInput({
    className = "",
    label,
    value = undefined,
    min = 0,
    ...
    onChange,
    ...restProps
}: VitalSignRespiratoryRateAsBreathsPerMinuteInputProps) {
    return (
        <input
            className={`vital-sign-respiratory-rate-as-breaths-per-minute-input ${className}`}
            type="number"
            aria-label={label}
            value={value}
