...
//   children — ReactNode, optional. Content rendered inside (e.g., "Loading..." text).
...
//   - Optional visible text comes through children prop
//
// Claude rules:
...
export default function ProgressSpinner({
    ...
    return (
        <div
        className={`progress-spinner ${className}`}
        role="status"
        aria-label={label}
        aria-live="polite"
        {...restProps}
