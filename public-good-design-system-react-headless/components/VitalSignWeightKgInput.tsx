...
//
// Syntax:
//   <VitalSignWeightKgInput label="Weight (kg)" value={value} onChange={setValue} />
//
// Examples:
//
//   <VitalSignWeightKgInput label="Weight (kg)" value={value} onChange={setValue} />
//
//
//   <VitalSignWeightKgInput label="Weight (kg)" value={value} onChange={setValue} required />
//
// Keyboard:
...
export interface VitalSignWeightKgInputProps {
    className?: string;
    label: string;
...
export default function VitalSignWeightKgInput({
    className = "",
    label,
    value = undefined,
    min = 0,
    ...
    onChange,
    ...restProps
}: VitalSignWeightKgInputProps) {
    return (
        <input
            className={`vital-sign-weight-kg-input ${className}`}
            type="number"
            aria-label={label}
            value={value}
