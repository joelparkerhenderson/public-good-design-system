...
export interface MeasurementSystemViewProps {
    className?: string;
...
export default function MeasurementSystemView({
    className = "",
    value,
    label = undefined,
    ...restProps
}: MeasurementSystemViewProps) {
    return (
        <span
        className={`measurement-system-view ${className}`}
        aria-label={label}
