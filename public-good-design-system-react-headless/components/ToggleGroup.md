...
- Accepts a `children` ReactNode for rendering toggle button elements inside the group
...
- `children`: ReactNode (required) -- toggle button elements to render inside the group
