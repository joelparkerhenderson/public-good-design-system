...
// labelling and clinically appropriate min, max, and step constraints. It
...
//   value — number | undefined, default undefined. Current HDL cholesterol value; controlled.
...
//
// Syntax:
//   <VitalSignCholesterolAsHdlMmolPerLitreInput label="HDL cholesterol" value={value} onChange={setValue} />
//
// Examples:
//
//   <VitalSignCholesterolAsHdlMmolPerLitreInput label="HDL cholesterol" value={value} onChange={setValue} />
//
//
//   <VitalSignCholesterolAsHdlMmolPerLitreInput label="HDL cholesterol" value={value} onChange={setValue} required />
//
// Keyboard:
...
export interface VitalSignCholesterolAsHdlMmolPerLitreInputProps {
    className?: string;
    label: string;
...
export default function VitalSignCholesterolAsHdlMmolPerLitreInput({
    className = "",
    label,
    value = undefined,
    min = 0,
    ...
    onChange,
    ...restProps
}: VitalSignCholesterolAsHdlMmolPerLitreInputProps) {
    return (
        <input
            className={`vital-sign-cholesterol-as-hdl-mmol-per-litre-input ${className}`}
            type="number"
            aria-label={label}
            value={value}
