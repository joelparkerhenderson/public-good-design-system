...
VitalSignBodyTemperatureCelciusInput is a headless component that wraps a native `<input type="number">` element for entering a body temperature value in degrees Celsius. It provides accessible labelling and physiologically appropriate default constraints (30-45 degrees Celsius).
