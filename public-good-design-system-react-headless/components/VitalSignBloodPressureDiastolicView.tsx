...
// is the display-only companion to VitalSignBloodPressureDiastolicInput, used
...
//
//
//   <VitalSignBloodPressureDiastolicView value={90} label="90 mmHg diastolic" />
//
// Keyboard:
...
export interface VitalSignBloodPressureDiastolicViewProps {
    className?: string;
...
export default function VitalSignBloodPressureDiastolicView({
    className = "",
    value,
    label,
    ...restProps
}: VitalSignBloodPressureDiastolicViewProps) {
    return (
        <span
            className={`vital-sign-blood-pressure-diastolic-view ${className}`}
            role="img"
            aria-label={label}
            data-value={value}
            {...restProps}
