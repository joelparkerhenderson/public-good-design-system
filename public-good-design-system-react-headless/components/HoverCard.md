...
- Accepts a `children` ReactNode for flexible card content
...
- `open`: boolean (default: `false`) -- whether the hover card is currently visible; controlled
