...
export interface NetPromoterScoreViewProps {
    className?: string;
...
export default function NetPromoterScoreView({
    className = "",
    label,
    value = "",
    ...restProps
}: NetPromoterScoreViewProps) {
    return (
        
        <span
        className={`net-promoter-score-view ${className}`}
        aria-label={label}
