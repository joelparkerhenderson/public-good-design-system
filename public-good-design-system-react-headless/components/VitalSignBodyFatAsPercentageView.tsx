...
// VitalSignBodyFatAsPercentageInput, used for showing body fat percentage readings
...
//
//
//   <VitalSignBodyFatAsPercentageView value={15.0} label="15.0 percent body fat" />
//
// Keyboard:
...
export interface VitalSignBodyFatAsPercentageViewProps {
    className?: string;
...
export default function VitalSignBodyFatAsPercentageView({
    className = "",
    value,
    label,
    ...restProps
}: VitalSignBodyFatAsPercentageViewProps) {
    return (
        <span
            className={`vital-sign-body-fat-as-percentage-view ${className}`}
            role="img"
            aria-label={label}
            data-value={value}
            {...restProps}
