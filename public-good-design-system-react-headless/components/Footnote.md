...
- Accepts a `children` ReactNode for flexible footnote content (text, links, citations)
...
- `children`: ReactNode (required) -- footnote content to render inside the aside
