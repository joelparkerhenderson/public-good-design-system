...
- `value`: string (default: "", controlled) -- controlled measurement unit value
...
```tsx
<MeasurementUnitInput label="Unit" value + onChange />
<MeasurementUnitInput label="Unit of measure" value + onChange required />
```
