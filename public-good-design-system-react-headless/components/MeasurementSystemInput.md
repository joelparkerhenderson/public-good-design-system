...
- `value`: string (default: "", controlled) -- controlled measurement system name
...
```tsx
<MeasurementSystemInput label="Measurement system" value + onChange />
<MeasurementSystemInput label="System" value + onChange required />
```
