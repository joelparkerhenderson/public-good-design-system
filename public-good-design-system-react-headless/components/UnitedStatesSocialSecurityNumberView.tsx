...
export interface UnitedStatesSocialSecurityNumberViewProps {
    className?: string;
...
export default function UnitedStatesSocialSecurityNumberView({
    className = "",
    label,
    value = "",
    ...restProps
}: UnitedStatesSocialSecurityNumberViewProps) {
    return (
        <span
        className={`united-states-social-security-number-view ${className}`}
        aria-label={label}
