...
- The `value` prop supports controlled component usage with `value + onChange` for two-way binding of the hex color string
...
- `value`: string (default: `"#000000"`) -- current hex color string, controlled via `value + onChange`
