...
VitalSignWeightAsKgInput is a headless component that wraps a native `<input type="number">` element for entering a weight value in kilograms (kg). It provides accessible labelling and physiologically appropriate default constraints (0-500 kg).
