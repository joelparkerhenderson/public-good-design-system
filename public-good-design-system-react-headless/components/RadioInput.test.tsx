...
import Subject from "./RadioInput";

describe("RadioInput", () => {
    test("renders a radio input", () => {
        render(<Subject label="Option A" />);
    ...
    test("supports name and value", () => {
        render(<Subject label="A" name="grp" value="a" />);
