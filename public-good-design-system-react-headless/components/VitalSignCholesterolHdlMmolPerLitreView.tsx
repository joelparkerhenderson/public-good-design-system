// VitalSignCholesterolHdlMmolPerLitreView component
//
...
// to VitalSignCholesterolHdlMmolPerLitreInput, used for showing HDL cholesterol
...
//
//
//   <VitalSignCholesterolHdlMmolPerLitreView value={2.0} label="2.0 mmol/L HDL cholesterol" />
//
// Keyboard:
...
export interface VitalSignCholesterolHdlMmolPerLitreViewProps {
    className?: string;
...
export default function VitalSignCholesterolHdlMmolPerLitreView({
    className = "",
    value,
    label,
    ...restProps
}: VitalSignCholesterolHdlMmolPerLitreViewProps) {
    return (
        <span
            className={`vital-sign-cholesterol-hdl-mmol-per-litre-view ${className}`}
            role="img"
            aria-label={label}
            data-value={value}
            {...restProps}
