...
//   value — number | undefined, default undefined. Current HRV value; controlled.
...
//
// Syntax:
//   <VitalSignHeartRateVariabilityInput label="HRV" value={value} onChange={setValue} />
//
// Examples:
//
//   <VitalSignHeartRateVariabilityInput label="HRV" value={value} onChange={setValue} />
//
//
//   <VitalSignHeartRateVariabilityInput label="HRV" value={value} onChange={setValue} required />
//
// Keyboard:
...
export interface VitalSignHeartRateVariabilityInputProps {
    className?: string;
    label: string;
...
export default function VitalSignHeartRateVariabilityInput({
    className = "",
    label,
    value = undefined,
    min = 0,
    ...
    onChange,
    ...restProps
}: VitalSignHeartRateVariabilityInputProps) {
    return (
        <input
            className={`vital-sign-heart-rate-variability-input ${className}`}
            type="number"
            aria-label={label}
            value={value}
