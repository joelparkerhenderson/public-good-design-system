<script setup lang="ts">
    ...
    //
    // Syntax:
    //   <VitalSignHeightCmInput label="Height (cm)" v-model />
    //
    // Examples:
    ...
    //   <VitalSignHeightCmInput label="Height (cm)" v-model required />
    //
    // Keyboard:
...
<template>
    <!-- VitalSignHeightCmInput.vue -->
    <input
        class="vital-sign-height-cm-input"
        type="number"
        :aria-label="label"
        v-model="modelValue"
        :min="min"
