<script setup lang="ts">
    ...
    //
    // Syntax:
    //   <VitalSignWeightKgInput label="Weight (kg)" v-model />
    //
    // Examples:
    ...
    //   <VitalSignWeightKgInput label="Weight (kg)" v-model required />
    //
    // Keyboard:
...
<template>
    <!-- VitalSignWeightKgInput.vue -->
    <input
        class="vital-sign-weight-kg-input"
        type="number"
        :aria-label="label"
        v-model="modelValue"
        :min="min"
