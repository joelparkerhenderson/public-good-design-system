<script setup lang="ts">
    ...
    //
    // Syntax:
    //   <VitalSignVO2MaxMlPerKgPerMinuteInput label="VO2 max" v-model />
    //
    // Examples:
    //   <!-- VO2 max input with defaults -->
    //   <VitalSignVO2MaxMlPerKgPerMinuteInput label="VO2 max (ml/kg/min)" v-model />
    //
    //   <!-- Required VO2 max input -->
    //   <VitalSignVO2MaxMlPerKgPerMinuteInput label="VO2 max" v-model required />
    //
    // Keyboard:
...
<template>
    <!-- VitalSignVO2MaxMlPerKgPerMinuteInput.vue -->
    <input
        class="vital-sign-vo2-max-ml-per-kg-per-minute-input"
        type="number"
        :aria-label="label"
        v-model="modelValue"
        :min="min"
