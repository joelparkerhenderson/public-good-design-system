<script setup lang="ts">
    ...
    //
    // Syntax:
    //   <VitalSignBodyFatAsPercentageInput label="Body fat percentage" v-model />
    //
    // Examples:
    ...
    //   <VitalSignBodyFatAsPercentageInput label="Body fat percentage" v-model required />
    //
    // Keyboard:
...
<template>
    <!-- VitalSignBodyFatAsPercentageInput.vue -->
    <input
        class="vital-sign-body-fat-as-percentage-input"
        type="number"
        :aria-label="label"
        v-model="modelValue"
        :min="min"
