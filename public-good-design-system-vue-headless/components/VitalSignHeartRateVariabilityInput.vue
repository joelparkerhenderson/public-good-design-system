<script setup lang="ts">
    ...
    //
    // A headless numeric input for entering a heart rate variability (HRV) value
    // in milliseconds. Wraps a native <input type="number"> element with accessible
    // labelling and sensible default constraints (0-500 ms). Commonly used in
    ...
    //
    // Syntax:
    //   <VitalSignHeartRateVariabilityInput label="HRV" v-model />
    //
    // Examples:
    //   <!-- HRV input with defaults -->
    //   <VitalSignHeartRateVariabilityInput label="HRV (ms)" v-model />
    //
    //   <!-- Required HRV input -->
    //   <VitalSignHeartRateVariabilityInput label="HRV" v-model required />
    //
    // Keyboard:
...
<template>
    <!-- VitalSignHeartRateVariabilityInput.vue -->
    <input
        class="vital-sign-heart-rate-variability-input"
        type="number"
        :aria-label="label"
        v-model="modelValue"
        :min="min"
