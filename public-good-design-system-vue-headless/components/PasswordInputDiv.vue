<script setup lang="ts">
    ...
    //
    // Syntax:
    //   <PasswordInputDiv label="Password" v-model />
    //
    // Examples:
    ...
    //   <PasswordInputDiv label="Password" v-model showToggle={false} />
    //
    //   <!-- Custom toggle label for internationalization -->
    //   <PasswordInputDiv label="Mot de passe" v-model toggleLabel="Afficher le mot de passe" />
    //
    // Keyboard:
...
<template>
    <!-- PasswordInputDiv.vue -->
    <div
        class="password-input-div"
    >
        <input
