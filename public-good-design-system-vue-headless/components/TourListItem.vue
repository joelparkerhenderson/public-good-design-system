<script setup lang="ts">
    ...
    //   <TourList label="Getting started" v-model:active>
    ...
    //   - Uses computed() for computed fullLabel with step progress
    //
    // References:
    ...
    const fullLabel = computed(() =>
        props.stepNumber != null && props.totalSteps != null
            ? `${props.label} (Step ${props.stepNumber} of ${props.totalSteps})`
            : props.label,
    );
