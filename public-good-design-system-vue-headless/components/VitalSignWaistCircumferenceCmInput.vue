<script setup lang="ts">
    ...
    // centimeters (cm). Wraps a native <input type="number"> element with
    // accessible labelling and sensible default constraints (0-300 cm).
    ...
    //
    // Syntax:
    //   <VitalSignWaistCircumferenceCmInput label="Waist circumference (cm)" v-model />
    //
    // Examples:
    //   <!-- Waist circumference input with defaults -->
    //   <VitalSignWaistCircumferenceCmInput label="Waist circumference (cm)" v-model />
    //
    //   <!-- Required waist circumference input -->
    //   <VitalSignWaistCircumferenceCmInput label="Waist circumference (cm)" v-model required />
    //
    // Keyboard:
...
<template>
    <!-- VitalSignWaistCircumferenceCmInput.vue -->
    <input
        class="vital-sign-waist-circumference-cm-input"
        type="number"
        :aria-label="label"
        v-model="modelValue"
        :min="min"
