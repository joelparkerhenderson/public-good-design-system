<script setup lang="ts">
    ...
    // kilograms (kg). Wraps a native <input type="number"> element with
    // accessible labelling and sensible default constraints (0-500 kg).
    ...
    //
    // Syntax:
    //   <VitalSignWeightAsKgInput label="Weight (kg)" v-model />
    //
    // Examples:
    //   <!-- Weight input with defaults -->
    //   <VitalSignWeightAsKgInput label="Weight (kg)" v-model />
    //
    //   <!-- Required weight input -->
    //   <VitalSignWeightAsKgInput label="Weight (kg)" v-model required />
    //
    // Keyboard:
...
<template>
    <!-- VitalSignWeightAsKgInput.vue -->
    <input
        class="vital-sign-weight-as-kg-input"
        type="number"
        :aria-label="label"
        v-model="modelValue"
        :min="min"
