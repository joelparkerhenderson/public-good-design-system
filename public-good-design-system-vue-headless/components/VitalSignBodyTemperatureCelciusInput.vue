<script setup lang="ts">
    ...
    //
    // Syntax:
    //   <VitalSignBodyTemperatureCelciusInput label="Body temperature" v-model />
    //
    // Examples:
    //   <!-- Body temperature input with defaults -->
    //   <VitalSignBodyTemperatureCelciusInput label="Body temperature (°C)" v-model />
    //
    //   <!-- Required body temperature input -->
    //   <VitalSignBodyTemperatureCelciusInput label="Body temperature" v-model required />
    //
    // Keyboard:
...
<template>
    <!-- VitalSignBodyTemperatureCelciusInput.vue -->
    <input
        class="vital-sign-body-temperature-celcius-input"
        type="number"
        :aria-label="label"
        v-model="modelValue"
        :min="min"
