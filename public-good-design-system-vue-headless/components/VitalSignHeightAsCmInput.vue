<script setup lang="ts">
    ...
    //
    // A headless numeric input for entering a height value in
    ...
    //
    // Syntax:
    //   <VitalSignHeightAsCmInput label="Height (cm)" v-model />
    //
    // Examples:
    //   <!-- Height input with defaults -->
    //   <VitalSignHeightAsCmInput label="Height (cm)" v-model />
    //
    //   <!-- Required height input -->
    //   <VitalSignHeightAsCmInput label="Height (cm)" v-model required />
    //
    // Keyboard:
...
<template>
    <!-- VitalSignHeightAsCmInput.vue -->
    <input
        class="vital-sign-height-as-cm-input"
        type="number"
        :aria-label="label"
        v-model="modelValue"
        :min="min"
