...
- Framework-agnostic
- Proper HTML examples
- ARIA references
- Consistent structure
- Helpful advice for designers and developers
- Suggestions for when to use, or when not to use

If the comonent is uses component composition pattern, then explain the pattern,
and the relationship to related components
