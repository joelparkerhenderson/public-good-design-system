# Vital Sign VO2 Max Ml Per Kg Per Minute Input
...
The consumer provides all CSS styling. The component renders with a `.vital-sign-vo2-max-ml-per-kg-per-minute-input` class for targeting. Common styling includes displaying "ml/kg/min" as a suffix label.
